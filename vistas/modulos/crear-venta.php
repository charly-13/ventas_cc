...
======================================-->
<div id="mostrarImagen" class="modal fade" role="dialog" >
  <div class="modal-dialog  bd-example-modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body cambioImagen" >
        <img class=""  src="" class="img-rounded" alt="Cinque Terre" width="304" height="336" /> </div>
      <div class="modal-footer">
